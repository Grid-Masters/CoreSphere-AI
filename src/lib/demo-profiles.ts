...
export const demoProfiles: DemoProfile[] = [
  ...
  { email: "d.obi@ubagroup.com", name: "Daniel Obi", initials: "DO", label: "QA Officer", unit: "Quality Assurance Team (Q.A)", positionCode: "QA_OFFICER" },
  { email: "o.balogun@ubagroup.com", name: "Olu Balogun", initials: "OB", label: "QA Team Lead", unit: "Quality Assurance Team (Q.A)", positionCode: "QA_TEAM_LEAD" },
  { email: "g.iheanacho@ubagroup.com", name: "Grace Iheanacho", initials: "GI", label: "QA Unit Head", unit: "Quality Assurance Team (Q.A)", positionCode: "QA_UNIT_HEAD" },
  { email: "c.paul@ubagroup.com", name: "Chioma Paul", initials: "CP", label: "L&D Officer", unit: "Learning and Development Team (L & D)", positionCode: "LD_OFFICER" },
  { email: "p.okonkwo@ubagroup.com", name: "Peter Okonkwo", initials: "PO", label: "L&D Team Lead", unit: "Learning and Development Team (L & D)", positionCode: "LD_TEAM_LEAD" },
  { email: "v.ekpo@ubagroup.com", name: "Victoria Ekpo", initials: "VE", label: "L&D Unit Head", unit: "Learning and Development Team (L & D)", positionCode: "LD_UNIT_HEAD" },
